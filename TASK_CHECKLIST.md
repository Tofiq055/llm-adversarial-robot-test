...
### Veri Seti Hazırlığı
- [x] 65 test promptundan **tamamen bağımsız** yeni adversarial promptlar yaz (ezberleme önleme)
- [x] Kaliteli LLM (Gemini/Claude) ile bu bağımsız promptlar için **kısıtlama aşan zararlı ROS2 kodları** üret
- [x] GitHub'dan ek güvenli ROS2/MoveIt2 scriptleri kazı (hibrit veri seti)
- [x] ROS2/MoveIt2/UR5e resmi dokümantasyonlarındaki örnek kodları ekle
- [x] Veri setini 89 → **500+ satıra** büyüt (923 satıra ulaştı)
